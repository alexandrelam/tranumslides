...
<div class="flex gap-14 mt-10">
  ...
  <p>Logiciel open source se définit comme une version business du logiciel libre.</p>
</div>
...
<div class="flex gap-14 mt-10 custom">
  <div>
...
```mermaid
graph TD
A[Crise du covid] --> B[augmentation des besoins: informatiques, télétravail, numérisation des échanges]
B --> C[multiplication des incidents de cyber-sécurité et des vols de données ]
```
</div>

<div class="flex mt-4 gap-10 mx-auto">
  <div class="w-1/3 bg-gray-200 p-10 rounded-full">
...
<div class="flex mt-20">
  <div class="text-center font-bold py-4 w-1/3 border">Coût</div>
  <div class="text-center font-bold py-4 w-1/3 border">Protection des données</div>
  <div class="text-center font-bold py-4 w-1/3 border">Personnalisation</div>
</div>
<div class="flex">
  <div class="text-center w-1/3 py-2 border">Souvent gratuit ou moins cher que les solutions propriétaires</div>
  <div class="text-center w-1/3 py-2 border">Développé avec la protection des données en objectif (pas de backdoors, pas de collecte des données)</div>
  <div class="text-center w-1/3 py-2 border">L’accès au code source permet une intégration plus facile avec des solutions déjà utilisées</div>
</div>
...
<img class="h-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/IBM_logo.svg/2560px-IBM_logo.svg.png"/>
